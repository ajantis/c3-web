...
object Metadata {
  ...
  val systemKeySet: Set[String] = Set(TAGS_META,MSG_CREATOR_META,MSG_DATE_META,S4_PROCESSED_FLAG_META,OWNER_ID_META,GROUP_ID_META,FS_PATH_META)
  //TODO filter metadata system key
}